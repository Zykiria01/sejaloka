...
const Navbar = () => {
  ...
  return (
    <nav className={`flex flex-col md:flex-row items-start justify-between right-0 left-0 absolute md:items-center p-6 bg-opacity-50 bg-slate-100 h-auto gap-7 md:gap-2`}>
      <div className='flex justify-between w-full md:w-max gap-3 items-center font-poppins font-bold'>
        <img className='w-40 h-7 md:w-42 md:h-10 items-center' src={Logo1} alt='' />
      ...
      <div className={`${isOpen ? 'flex ':'hidden'} md:flex`}>
        <ul className='flex flex-col md:flex-row gap-3 md:gap-7 text-lg'>
